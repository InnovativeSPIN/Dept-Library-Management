...
class LoginFrontend(object):
    def setupUi(self, Dialog):
        ...
        self.login_btn = QtWidgets.QPushButton(self.login,default=False, autoDefault=False)
...
class LibraryFrontend(object):
    def setupUi(self, MainWindow, current_user):
        ...
        self.add_student_year_cbox = QtWidgets.QLineEdit(self.add_students_tab)
        ...
        self.label_23.setGeometry(QtCore.QRect(50, 220, 81, 21))
        self.label_23.setObjectName("label_23")
        
        self.add_students_dept_cbox = QtWidgets.QComboBox(self.add_students_tab)
        self.add_students_dept_cbox.setGeometry(QtCore.QRect(160, 220, 111, 22))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.i_detail_year_label.setText(_translate("MainWindow", "Batch               :"))
        ...
        self.label_20.setText(_translate("MainWindow", "Batch"))
        ...
        self.label_43.setText(_translate("MainWindow", "Batch                     :"))
    ...
    def onclick_add_students2db(self):
        ...
        batch = self.add_student_year_cbox.text()
        dept = self.add_students_dept_cbox.currentText()

        if self.check([reg_no, name]):
            add_student_2_db(reg_no, name, batch, dept)
            self.clear(to_clear=[self.add_student_reg_no_in,self.add_student_year_cbox, self.add_student_name_in], to_hide=[self.addstudentserror_msg])
